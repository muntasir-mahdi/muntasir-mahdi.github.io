...
This electroplating process supports the **Nb and NbN superconducting resonator, coplanar waveguides project** used for **magnon-magnon and magnon–photon coupling** studies. Details of the resonator design and measurement setup are described on <a href="{{ '/projects/nbn_resonator/' | relative_url }}"><strong>NbN Resonators</strong></a>.
