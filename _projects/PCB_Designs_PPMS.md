...
<div class="row justify-content-sm-center">
    <div class="col-sm-5 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/PCB/IP_OOP_designs.JPG" title="PCB design layout for sub-2 K measurements" class="img-fluid rounded z-depth-1" style="max-width: 90%;" %}
    </div>
    <div class="col-sm-5 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/PCB/PCB_ready_IP_OOP.jpg" title="IP PCB with mounted resonator chip with conductive silver paint" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
